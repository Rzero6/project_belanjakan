...
void main() {
  ...
  testWidgets('Delete cart success success', (WidgetTester tester) async {
    final userData =
    ...
    await tester.tapAt(const Offset(756.1, 98.8));
    await tester.pumpAndSettle();
    expect(
        find.widgetWithText(FadeTransition, 'Delete Success'), findsOneWidget);
  });
}
